...
static void	init_ray(t_data *data, int x)
{
	...
	data->raycast.ray_dir_x = data->player.dir_x + data->player.plane_x * data->raycast.camera_x;
	data->raycast.ray_dir_y = data->player.dir_y + data->player.plane_y * data->raycast.camera_x;
